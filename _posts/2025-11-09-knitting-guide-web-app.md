...
![应用主界面](/assets/images/posts/pixelknit/main-interface.png)
...
![手动路径选择](/assets/images/posts/pixelknit/manual-path-selection.png)
...
![放大镜功能](/assets/images/posts/pixelknit/magnifier.png)
*图5：放大镜功能，3倍放大显示局部细节*
...
<!-- TODO: add image: particle-background.png -->
*图8：粒子背景系统，动态交互式背景效果*

**响应式设计**：
适配桌面、平板和移动设备，使用媒体查询优化不同屏幕尺寸的显示效果。

<!-- TODO: add image: responsive-design.png -->
