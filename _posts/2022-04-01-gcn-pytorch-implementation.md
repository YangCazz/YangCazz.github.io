...
date: 2022-04-01 10:00:00.000000000 +08:00
categories:
- 图神经网络
- 深度学习
- PyTorch
...
在前面的文章中，我们深入探讨了GCN的数学原理<cite>[1]</cite>。现在让我们通过PyTorch和PyTorch Geometric来实现GCN<cite>[2]</cite>，并展示如何在实际任务中使用它。
...
为了更好地理解GCN的工作原理<cite>[1]</cite>，让我们手动实现GCN层：
...
GCN作为图神经网络的基础模型<cite>[1]</cite>，为后续学习更复杂的图神经网络架构奠定了重要基础。在下一篇文章中，我们将探讨图神经网络在医学图像处理中的应用。
...
<li>Fey, M., &amp; Lenssen, J. E. <em>Fast Graph Representation Learning with PyTorch Geometric</em>. ICLR Workshop on Representation Learning on Graphs and Manifolds, 2019. <a href="https://arxiv.org/abs/1903.02428">arXiv:1903.02428</a></li>
<li>PyTorch Geometric Documentation. <a href="https://pytorch-geometric.readthedocs.io/">pytorch-geometric.readthedocs.io</a></li>
</ol>
