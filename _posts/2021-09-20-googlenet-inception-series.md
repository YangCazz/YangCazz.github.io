...
date: 2021-09-20 10:00:00.000000000 +08:00
categories:
- 深度学习
- 经典网络
tags:
...
**命名由来**：GoogLeNet中的"L"大写是为了致敬Yann LeCun提出的LeNet <cite>[1]</cite>。
...
{% include paper-info.html 
   ...
   url_label="arXiv:1409.4842"
%}

**成绩**：ILSVRC 2014 分类任务第一名 <cite>[1]</cite>，与同年VGG形成两种不同的探索方向

### 网络结构

![GoogLeNet V1整体结构](/assets/images/posts/deep-learning/googlenet-v1-overview.png)

### 核心创新：Inception模块

![Inception V1模块](/assets/images/posts/deep-learning/googlenet-inception-v1.png)
...
**Internal Covariate Shift（内部协变量偏移）问题** <cite>[2]</cite>：
...
V3最重要的贡献是总结出了**通用设计准则** <cite>[3]</cite>，这些准则对后续研究有重要指导意义。
...
![Inception V3模块](/assets/images/posts/deep-learning/googlenet-inception-v3.png)
...
2015年何凯明提出ResNet残差结构后，V4研究了残差连接对Inception的影响 <cite>[4]</cite>。
...
![Inception V4模块](/assets/images/posts/deep-learning/googlenet-inception-v4.png)

![Reduction模块](/assets/images/posts/deep-learning/googlenet-inception-v4-reduction.png)

### Inception-ResNet

![GoogLeNet V4整体结构](/assets/images/posts/deep-learning/googlenet-v4-overview.png)

![Inception-ResNet模块](/assets/images/posts/deep-learning/googlenet-v4-inception-resnet.png)
...
<ol class="references">
<li>Szegedy, C., Liu, W., Jia, Y., Sermanet, P., Reed, S., Anguelov, D., Erhan, D., Vanhoucke, V., &amp; Rabinovich, A. <em>Going Deeper with Convolutions</em>. IEEE Conference on Computer Vision and Pattern Recognition (CVPR), 2015. arXiv: <a href="https://arxiv.org/abs/1409.4842">1409.4842</a></li>

<li>Ioffe, S. &amp; Szegedy, C. <em>Batch Normalization: Accelerating Deep Network Training by Reducing Internal Covariate Shift</em>. International Conference on Machine Learning (ICML), 2015. <a href="http://proceedings.mlr.press/v37/ioffe15.html">proceedings.mlr.press</a></li>

<li>Szegedy, C., Vanhoucke, V., Ioffe, S., Shlens, J., &amp; Wojna, Z. <em>Rethinking the Inception Architecture for Computer Vision</em>. IEEE Conference on Computer Vision and Pattern Recognition (CVPR), 2016. arXiv: <a href="https://arxiv.org/abs/1512.00567">1512.00567</a></li>

<li>Szegedy, C., Ioffe, S., Vanhoucke, V., &amp; Alemi, A. <em>Inception-v4, Inception-ResNet and the Impact of Residual Connections on Learning</em>. AAAI Conference on Artificial Intelligence, 2017. arXiv: <a href="https://arxiv.org/abs/1602.07261">1602.07261</a></li>

<li>Zhang, H., Li, S., Ma, Y., Li, M., Xie, Y., &amp; Zhang, Q. <em>Discovering and Explaining the Representation Bottleneck of DNNs</em>. International Conference on Learning Representations (ICLR), 2023. arXiv: <a href="https://arxiv.org/abs/2111.06236">2111.06236</a></li>
</ol>
