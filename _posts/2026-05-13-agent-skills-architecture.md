...
date: 2026-05-13 10:00:00.000000000 +08:00
categories:
- AI
- 软件工程
tags:
...
- 设计模式
- AI Agent
excerpt: 从 Anthropic 官方设计哲学、agentskills.io 开放标准到学术论文的系统分析，深入探讨 AI Agent Skills 的核心设计模式：渐进式披露、结构化认知约束、Plan-Execute-Verify
